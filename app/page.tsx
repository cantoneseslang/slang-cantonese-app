...
export default function Home() {
  ...
  const [handButtonImageError, setHandButtonImageError] = useState(false);
  const [muteButtonImageError, setMuteButtonImageError] = useState(false);
  ...
  const exitHiddenMode = () => {
    ...
    setIsMuted(false);
    setHandButtonImageError(false);
    setMuteButtonImageError(false);
            ...
            >
              {handButtonImageError ? (
                ...
                <img
                  ...
                  onError={() => setHandButtonImageError(true)}
                  onContextMenu={(e) => {
                    e.preventDefault();
                    e.stopPropagation();
                    return false;
            ...
            >
              {muteButtonImageError ? (
                ...
                <img
                  ...
                  onError={() => setMuteButtonImageError(true)}
                  onContextMenu={(e) => {
                    e.preventDefault();
                    e.stopPropagation();
                    return false;
