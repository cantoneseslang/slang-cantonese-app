              ...
              <div style={{ 
                ...
                <div style={{ marginBottom: '2rem' }}>
                  ...
                  <ul style={{
                    ...
                    {selectedPlan === 'free' 
                      ? ['お気に入り6個まで', '発音チェックゲーム', '基本カテゴリーの単語へアクセス'].map((benefit, idx) => (
                        <li key={idx} style={{
                          display: 'flex',
                          alignItems: 'center',
                          gap: '0.75rem',
                      ...
                      : selectedPlan === 'subscription'
                      ? ['お気に入り無制限', 'モード切り替え（ノーマルモード・学習）', 'note 教科書自動更新', 'テキストOCR', '発音チェック', '発音チェックゲーム', '全カテゴリーの単語へアクセス', '音声速度調整', '広告なし'].map((benefit, idx) => (
                        <li key={idx} style={{
                          display: 'flex',
                          alignItems: 'center',
                          gap: '0.75rem',
