...
import { HiddenMode } from '@/components/interpreter/HiddenMode';
    ...
    >
      ...
      {isHiddenMode && (
        <HiddenMode
          ...
          onExit={exitHiddenMode}
          onMicPress={handleMicPress}
          onMicRelease={handleMicRelease}
          interpreterLanguage={interpreterLanguage}
          onLanguageChange={handleInterpreterLanguageChange}
          showTitle={showTitle}
          interpreterTitle={interpreterTitle}
