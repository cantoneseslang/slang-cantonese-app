...
const privacyContent = {
  ja: {
    title: 'プライバシーポリシー',
    content: [
      { text: '当サービスは、ユーザーの個人情報を適切に取り扱い、目的の範囲内で安全に管理します。' },
      { list: [
        '収集する情報：メールアドレス、操作ログ等（必要最小限）',
        '利用目的：サービス提供、品質向上、お問い合わせ対応',
        '第三者提供：法令に基づく場合を除き行いません',
        '安全管理措置：アクセス制御、暗号化等の適切な対策を実施',
        '開示・訂正・削除：合理的範囲で速やかに対応します'
      ]},
      { text: '本ポリシーの内容は、必要に応じて改定される場合があります。' }
    ]
  },
  en: {
    title: 'Privacy Policy',
    content: [
      { text: 'We handle users\' personal information appropriately and manage it securely within the scope of its intended purpose.' },
      { list: [
        'Information collected: Email addresses, operation logs, etc. (minimal necessary)',
        'Purpose of use: Service provision, quality improvement, inquiry response',
        'Third-party provision: Not provided except as required by law',
        'Security measures: Appropriate measures such as access control and encryption',
        'Disclosure, correction, deletion: Prompt response within reasonable scope'
      ]},
      { text: 'The content of this policy may be revised as necessary.' }
    ]
  }
};
