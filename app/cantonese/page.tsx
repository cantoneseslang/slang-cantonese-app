export default function CantoneseIntroPage() {
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1.5rem' }}>
      ...
      <section style={{ display: 'grid', gap: '0.5rem', marginBottom: '1.25rem' }}>
        <h2 style={{ fontSize: '1.125rem', fontWeight: 800 }}>2. 漢字の違い</h2>
        <p>
          広東語で使う漢字は繁体字、標準中国語（普通話）で使われる漢字は簡体字が中心です。繁体字は元の字形に近く画数が多いのが特徴、簡体字は1950年代以降に画数を減らした字形です。
      ...
      <section style={{ display: 'grid', gap: '0.75rem' }}>
        <p>
          ...
          (<a href="/about" style={{ color: '#3b82f6', textDecoration: 'underline' }}>https://slang-cantonese-app.vercel.app/about</a>)
        </p>
      </section>
    </main>
  )
