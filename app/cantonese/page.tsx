  ...
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1.5rem' }}>
      ...
      <section style={{ display: 'grid', gap: '0.75rem', marginBottom: '1.25rem' }}>
        <p>
          広東語は中国語より難しい？——そう思われがちなのは、広東語が「中国語の方言」と呼ばれる一方で、実際には文字や発音体系が大きく異なるためです。
          日本語でいう「大阪弁・東北弁」のイメージとは違い、まず使う字が違います。
        </p>
      </section>

      <section style={{ display: 'grid', gap: '0.5rem', marginBottom: '1.25rem' }}>
        <h2 style={{ fontSize: '1.125rem', fontWeight: 800 }}>1. 漢字の違い</h2>
        <p>
      ...
      <section style={{ display: 'grid', gap: '0.5rem', marginBottom: '1.25rem' }}>
        <h2 style={{ fontSize: '1.125rem', fontWeight: 800 }}>2-1. 中国語の標準語は「普通话 (pǔtōnghuà)」</h2>
        <p>
      ...
      <section style={{ display: 'grid', gap: '0.5rem', marginBottom: '1.25rem' }}>
        <h2 style={{ fontSize: '1.125rem', fontWeight: 800 }}>1-1. 中国には多くの言語（方言）がある</h2>
        <p>
      ...
      <section style={{ display: 'grid', gap: '0.5rem', marginBottom: '1.25rem' }}>
        <h2 style={{ fontSize: '1.125rem', fontWeight: 800 }}>2-2. 最大の違いは「文字」</h2>
        <p>
          標準語の簡体字は1950年代に中国で制定。香港・マカオでは植民地時代から<strong>繁体字</strong>を使い続け、返還後も繁体字文化が継承されています。日本人にとっては繁体字の方が意味推測しやすく、香港や台湾では筆談もある程度可能です。
        </p>
      </section>

      <section style={{ display: 'grid', gap: '0.75rem' }}>
        <p>
          ここまで読んでいただいた方は、きっと広東語に興味をお持ちの方。まずは本アプリで音から楽しく学んでいきましょう。
        </p>
      </section>
    </main>
  )
